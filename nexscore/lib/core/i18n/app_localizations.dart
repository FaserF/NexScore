...
class AppLocalizations {
  ...
  localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'home_tag_volleyball': 'Volleyball',
      ...
      'vb_tagline': 'Professional Indoor & Beach Scoreboard',
      'vb_indoor': 'Indoor',
      'vb_beach': 'Beach',
      'vb_team_a': 'Team A',
      'vb_team_b': 'Team B',
      ...
      'vb_signal_serve': 'Serve',
      'vb_signal_team_to_serve': 'Team to Serve',
      'vb_signal_change_sides': 'Change Sides',
      ...
      'vb_signal_over_net': 'Over Net',
      'vb_signal_four_hits': 'Four Hits',
      'vb_signal_double_hit': 'Double Hit',
      'vb_signal_rotation_fault': 'Rotation Fault',
      'vb_signal_held_ball': 'Held Ball',
    ...
    'de': {
      ...
      'vb_signal_serve': 'Aufschlag',
      'vb_signal_team_to_serve': 'Aufschlagrecht',

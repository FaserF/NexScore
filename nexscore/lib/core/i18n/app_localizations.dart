...
class AppLocalizations {
  ...
  localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'home_filter_all': 'All',
      'filter_game_type': 'Filter Game Type',
      'all_games': 'All Games',
      ...
      'vb_pdf_set_time': '{0} – {1}',
      'vb_serving': 'SERVE',
      'vb_serve_history': 'SERVE HISTORY',
      'vb_select_initial_server': 'Select Initial Server',
      'vb_select_initial_server_desc': 'Who starts the service?',
      'vb_set_with_number': 'Set {0}: ',
      'vb_pdf_time': 'TIME',
      'vb_pdf_nr_symbol': '#',
      'vb_timeouts': 'TIMEOUTS',
      ...
      'settings_sfx_beep': 'Beep Sound (Buttons)',
      'settings_sfx_fanfare': 'Fanfare Sound (Winners)',
      'settings_sfx_other': 'Other Sound Effects',
      ...
      'help_faq': 'FAQ & Quick Guides',
      'help_faq_q1': 'How to start a multiplayer game?',
      'help_faq_a1': 'Go to the Multiplayer hub. One player taps "Host a Room" and shares their QR code/Room Code. Other players tap "Join a Room" and scan the code to play together.',
      'help_faq_q2': 'How does scoring work?',
      'help_faq_a2': 'Simply choose a game from the list, select or add players, and input the round scores after each round. The app automatically handles all calculations and history.',
      'help_faq_q3': 'How to backup my game data?',
      'help_faq_a3': 'Open Settings, go to "Backup & Restore" to export your data. You can restore it on another device anytime by importing that file.',
      'settings_section_general': 'General Settings',
      'settings_section_audio_profile': 'Sound & Host Profile',
      'settings_section_advanced': 'Advanced & Backup',
      ...
      'multiplayer_host_desc': 'Start a game room as Host and let others join by scanning your QR code.',
      'multiplayer_join': 'Join a Room',
      'multiplayer_join_desc': 'Join an active game room by scanning a QR code or entering a room code.',
      ...
      'multiplayer_error_details': 'Error Details',
      'multiplayer_error_retry': 'Retry',
      ...
      'multiplayer_waiting_for_host': 'Waiting for host to start...',
      'multiplayer_lobby_closed_title': 'Lobby Closed',
      'multiplayer_lobby_closed_body': 'The host has closed the lobby or the connection was lost.',
      'multiplayer_host_disconnected_title': 'Host Disconnected',
      'multiplayer_host_disconnected_body': 'The host is offline or left the room.',
      'multiplayer_room_creation_failed': 'Failed to create a room. Please try again.',
      ...
      'campaign_start_mission': 'START MISSION',
      'campaign_replay_mission': 'REPLAY MISSION',
      'campaign_locked': 'LOCKED',
      'campaign_reset_title': 'Reset Campaign Progress?',
      'campaign_reset_body': 'This will delete all completed campaign missions.',
      'campaign_reset_success': 'Campaign progress reset successfully!',
      'campaign_reset_confirm': 'RESET',
      'campaign_deselect_tooltip': 'Deselect Level',
      'campaign_reset_tooltip': 'Reset Campaign',
      'campaign_meta_variant': 'Variant',
      'campaign_meta_difficulty': 'Difficulty',
      'campaign_meta_target': 'Target',
      'campaign_level_label': 'LEVEL',
      'campaign_mission_label': 'MISSION',
      'campaign_error_loading': 'Error loading progress',
      'campaign_cancel': 'CANCEL',
      'tutorial_appbar_title': 'SUDOKU ACADEMY: LEARN',
      'tutorial_undo_tooltip': 'Undo last move',
      'tutorial_reset_tooltip': 'Reset tutorial step',
      'tutorial_next_step': 'NEXT STEP',
      'tutorial_finish': 'FINISH',
      'tutorial_correct': 'Correct! Well done.',
      'tutorial_step1_title': '1. Rows & Columns',
      'tutorial_step1_instruction': 'Each row and column must contain digits 1 to 4 without repetition.\n\nLook at the highlighted first row. Only one number is missing to complete the sequence [1, 2, 3, ?].',
      'tutorial_step1_target': 'Select the highlighted empty cell in Row 1 and tap "4".',
      'tutorial_step2_title': '2. Box Areas',
      'tutorial_step2_instruction': 'A 4x4 Sudoku board is divided into four 2x2 box areas. Each box must contain digits 1 to 4.\n\nCheck the bottom-left box. The digits [3, 4, 1] are filled, meaning only one number remains.',
      'tutorial_step2_target': 'Select the highlighted cell in the bottom-left box and tap "2" to complete it.',
      'tutorial_step3_title': '3. Diagonal X-Sudoku',
      'tutorial_step3_instruction': 'In Diagonal (X) Sudoku, the two main diagonals (top-left to bottom-right, and top-right to bottom-left) must also contain digits 1 to 4 without repeats.',
      'tutorial_step3_target': 'Select the bottom-right corner cell on the main diagonal and tap "3" to complete the diagonal.',
      ...
      'game_sudoku': 'Sudoku',
      'desc_sudoku': 'Professional Sudoku with multiple variants, game modes, visual themes, background music & cloud synchronization.',
      'sudoku_title': 'Sudoku',
      'sudoku_variant': 'Variant',
      'sudoku_variant_standard': 'Standard 9x9',
      'sudoku_variant_diagonal': 'Sudoku X (Diagonal)',
      'sudoku_variant_hyper': 'Hyper Sudoku',
      'sudoku_variant_mini': 'Mini 6x6',
      ...
      'sudoku_mode': 'Game Mode',
      'sudoku_mode_classic': 'Classic',
      'sudoku_mode_zen': 'Zen',
      'sudoku_mode_timeattack': 'Time Attack',
      'sudoku_mistakes': 'Mistakes',
      'sudoku_timer': 'Timer',
      'sudoku_daily_challenge': 'Daily Challenge',
      'sudoku_leaderboard': 'Sudoku Leaderboard',
      'sudoku_restart': 'Restart',
      'sudoku_undo': 'Undo',
      'sudoku_notes': 'Notes',
      'sudoku_erase': 'Erase',
      'sudoku_hint': 'Hint',
      'sudoku_game_over': 'Game Over!',
      'sudoku_game_over_desc': 'You have made too many mistakes.',
    ...
    'de': {
      ...
      'settings_sfx_beep': 'Tastenton (Buttons)',
      'settings_sfx_fanfare': 'Fanfare (Gewinner)',
      'settings_sfx_other': 'Sonstige Soundeffekte',
      ...
      'filter_game_type': 'Spieltyp filtern',
      ...
      'help_faq': 'FAQ & Kurzanleitungen',
      'help_faq_q1': 'Wie starte ich ein Multiplayer-Spiel?',
      'help_faq_a1': 'Gehe in den Multiplayer-Hub. Ein Spieler tippt auf "Hosten" und teilt den QR-Code/Raum-Code. Andere Spieler tippen auf "Beitreten" und scannen den Code ein, um zusammen zu spielen.',
      'help_faq_q2': 'Wie funktioniert die Punkteberechnung?',
      'help_faq_a2': 'Wähle einfach ein Spiel aus der Liste, wähle oder erstelle Spieler und gib nach jeder Runde die Punkte ein. Die App berechnet alle Summen und den Verlauf automatisch.',
      'help_faq_q3': 'Wie kann ich meine Spieldaten sichern?',
      'help_faq_a3': 'Öffne die Einstellungen und wähle unter "Backup & Wiederherstellung" den Export aus. Du kannst die Datei auf einem anderen Gerät jederzeit wieder importieren.',
      'settings_section_general': 'Allgemeine Einstellungen',
      'settings_section_audio_profile': 'Ton & Host-Profil',
      'settings_section_advanced': 'Erweitert & Datensicherung',
      ...
      'multiplayer_host_desc': 'Erstelle eine neue Spielrunde als Host und lasse andere per QR-Code beitreten.',
      'multiplayer_join': 'Raum beitreten',
      'multiplayer_join_desc': 'Tritt einer aktiven Spielrunde bei, indem du einen QR-Code scannst oder einen Raum-Code eingibst.',
      ...
      'multiplayer_error_details': 'Fehlerdetails',
      'multiplayer_error_retry': 'Wiederholen',
      ...
      'multiplayer_waiting_for_host': 'Warte auf den Host...',
      'multiplayer_lobby_closed_title': 'Lobby geschlossen',
      'multiplayer_lobby_closed_body': 'Der Host hat die Lobby geschlossen oder die Verbindung wurde unterbrochen.',
      'multiplayer_host_disconnected_title': 'Verbindung zum Host verloren',
      'multiplayer_host_disconnected_body': 'Der Host ist offline oder hat den Raum verlassen.',
      'multiplayer_room_creation_failed': 'Lobby-Erstellung fehlgeschlagen. Bitte erneut versuchen.',
      ...
      'campaign_start_mission': 'MISSION STARTEN',
      'campaign_replay_mission': 'MISSION WIEDERHOLEN',
      'campaign_locked': 'GESPERRT',
      'campaign_reset_title': 'Kampagnenfortschritt zurücksetzen?',
      'campaign_reset_body': 'Dadurch werden alle abgeschlossenen Kampagnenmissionen gelöscht.',
      'campaign_reset_success': 'Kampagnenfortschritt erfolgreich zurückgesetzt!',
      'campaign_reset_confirm': 'ZURÜCKSETZEN',
      'campaign_deselect_tooltip': 'Level abwählen',
      'campaign_reset_tooltip': 'Kampagne zurücksetzen',
      'campaign_meta_variant': 'Variante',
      'campaign_meta_difficulty': 'Schwierigkeit',
      'campaign_meta_target': 'Ziel',
      'campaign_level_label': 'LEVEL',
      'campaign_mission_label': 'MISSION',
      'campaign_error_loading': 'Fehler beim Laden des Fortschritts',
      'campaign_cancel': 'ABBRECHEN',
      'tutorial_appbar_title': 'SUDOKU-AKADEMIE: LERNEN',
      'tutorial_undo_tooltip': 'Letzten Zug rückgängig machen',
      'tutorial_reset_tooltip': 'Tutorial-Schritt zurücksetzen',
      'tutorial_next_step': 'NÄCHSTER SCHRITT',
      'tutorial_finish': 'FERTIG',
      'tutorial_correct': 'Richtig! Gut gemacht.',
      'tutorial_step1_title': '1. Zeilen & Spalten',
      'tutorial_step1_instruction': 'Jede Zeile und Spalte muss die Ziffern 1 bis 4 ohne Wiederholung enthalten.\n\nSchau dir die hervorgehobene erste Zeile an. Es fehlt nur eine Zahl, um die Folge [1, 2, 3, ?] zu vervollständigen.',
      'tutorial_step1_target': 'Wähle die hervorgehobene leere Zelle in Zeile 1 und tippe auf „4“.',
      'tutorial_step2_title': '2. Boxbereiche',
      'tutorial_step2_instruction': 'Ein 4x4-Sudoku-Feld ist in vier 2x2-Boxbereiche unterteilt. Jede Box muss die Ziffern 1 bis 4 enthalten.\n\nSchau dir die untere linke Box an. Die Ziffern [3, 4, 1] sind bereits eingetragen, es fehlt also nur noch eine Zahl.',
      'tutorial_step2_target': 'Wähle die hervorgehobene Zelle in der unteren linken Box und tippe auf „2“, um sie zu vervollständigen.',
      'tutorial_step3_title': '3. Diagonal-X-Sudoku',
      'tutorial_step3_instruction': 'Beim Diagonal-(X-)Sudoku müssen auch die beiden Hauptdiagonalen (oben links nach unten rechts sowie oben rechts nach unten links) die Ziffern 1 bis 4 ohne Wiederholung enthalten.',
      'tutorial_step3_target': 'Wähle die Zelle in der unteren rechten Ecke der Hauptdiagonale und tippe auf „3“, um die Diagonale zu vervollständigen.',
      'account_data_stay_note':
      ...
      'vb_serve_history': 'AUCHSCHLAG-VERLAUF',
      'vb_select_initial_server': 'Erster Aufschlag',
      'vb_select_initial_server_desc': 'Wer hat den ersten Aufschlag?',
      ...
      'discard': 'Verwerfen',
      'game_sudoku': 'Sudoku',
      'desc_sudoku': 'Professionelles Sudoku mit verschiedenen Varianten, Spielmodi, Designs, Hintergrundmusik & Cloud-Synchronisierung.',
      'sudoku_title': 'Sudoku',
      'sudoku_variant': 'Variante',
      'sudoku_variant_standard': 'Standard 9x9',
      'sudoku_variant_diagonal': 'Sudoku X (Diagonal)',
      'sudoku_variant_hyper': 'Hyper Sudoku',
      'sudoku_variant_mini': 'Mini 6x6',
      'sudoku_difficulty': 'Schwierigkeit',
      'sudoku_difficulty_easy': 'Leicht',
      'sudoku_difficulty_medium': 'Mittel',
      'sudoku_difficulty_hard': 'Schwer',
      'sudoku_difficulty_expert': 'Experte',
      'sudoku_mode': 'Spielmodus',
      'sudoku_mode_classic': 'Klassisch',
      'sudoku_mode_zen': 'Zen',
      'sudoku_mode_timeattack': 'Zeitkampf',
      'sudoku_mistakes': 'Fehler',
      'sudoku_timer': 'Zeit',
      'sudoku_daily_challenge': 'Tägliche Herausforderung',
      'sudoku_leaderboard': 'Sudoku Bestenliste',
      'sudoku_restart': 'Neustart',
      'sudoku_undo': 'Rückgängig',
      'sudoku_notes': 'Notizen',
      'sudoku_erase': 'Löschen',
      'sudoku_hint': 'Hinweis',
      'sudoku_game_over': 'Spiel vorbei!',
      'sudoku_game_over_desc': 'Du hast zu viele Fehler gemacht.',
